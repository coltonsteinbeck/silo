...
import { assembleConversationContext, buildImageSummaryBlock } from '../../services/conversation-context';
...
describe('conversation-context', () => {
    ...
    test('buildImageSummaryBlock formats summaries and handles empty input', () => {
        ...
        const block = buildImageSummaryBlock(['[1|current] person dancing', '[2|reply_level_1] meme panel']);
