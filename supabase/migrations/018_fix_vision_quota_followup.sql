...
--   ALTER TABLE role_tier_quotas DROP COLUMN IF EXISTS vision_tokens;
--   ALTER TABLE guild_quotas DROP COLUMN IF EXISTS daily_vision_tokens;
--   ALTER TABLE guild_daily_usage DROP COLUMN IF EXISTS total_vision_tokens;
--   ALTER TABLE usage_tracking
--     DROP COLUMN IF EXISTS vision_requests,
--     DROP COLUMN IF EXISTS vision_tokens_used;
