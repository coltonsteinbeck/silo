...
(
    ...
    CREATE INDEX IF NOT EXISTS idx_user_memory_context_type ON user_memory(context_type);
    CREATE INDEX IF NOT EXISTS idx_user_memory_expires_at ON user_memory(expires_at) WHERE expires_at IS NOT NULL;
...
$$ language 'plpgsql';
    ...
    FOR EACH ROW
                ...
                DROP TRIGGER IF EXISTS update_server_memory_updated_at ON server_memory;
